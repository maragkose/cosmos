...
# along with COSMOS.  If not, see <http://www.gnu.org/licenses/>.
	...
	# --------------------------------------------------------
	# $Id: account_page.php,v 1.1.1.1 2009/01/08 07:30:19 chirag Exp $
	# --------------------------------------------------------
...
if($_REQUEST['confirm_hash']<>""){
?>
<input type="hidden" name="new_reg" value="<?php echo $_REQUEST['confirm_hash'];?>"/>
<?
}
?>
<?php } ?>
