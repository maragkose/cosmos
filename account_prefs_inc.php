...
<tr class="row-1">
	<td class="category">
		<?php echo lang_get( 'candidatenote_order' ) ?>
	</td>
	<td>
		<input type="radio" name="candidatenote_order" value="ASC" <?php check_checked( $t_pref->candidatenote_order, 'ASC' ); ?> /><?php echo lang_get( 'candidatenote_order_asc' ) ?>
		<input type="radio" name="candidatenote_order" value="DESC" <?php check_checked( $t_pref->candidatenote_order, 'DESC' ); ?> /><?php echo lang_get( 'candidatenote_order_desc' ) ?>
	</td>
</tr>
<?php
...
<tr class="row-2">
	<td class="category">
		<?php echo lang_get( 'email_on_candidatenote_added' ) ?>
	</td>
	<td>
		<input type="checkbox" name="email_on_candidatenote" <?php check_checked( $t_pref->email_on_candidatenote, ON ); ?> />
		<?php echo lang_get( 'with_minimum_severity' ) ?>
		<select name="email_on_candidatenote_min_severity">
			<option value="<?php echo OFF ?>"><?php echo lang_get( 'any' ) ?></option>
			<option value="<?php echo OFF ?>"></option>
			<?php print_enum_string_option_list( 'severity', $t_pref->email_on_candidatenote_min_severity ) ?>
		</select>
	</td>
</tr>
<tr class="row-1">
...
<tr class="row-1">
	<td class="category">
		<?php echo lang_get( 'email_candidatenote_limit' ) ?>
	</td>
	<td>
		<input type="text" name="email_candidatenote_limit" maxlength="2" size="2" value="<?php echo $t_pref->email_candidatenote_limit ?>">
	</td>
</tr>
<?php } else { ?>
		...
		<input type="hidden" name="email_on_candidatenote"  value="<?php echo $t_pref->email_on_candidatenote ?>" />
		...
		<input type="hidden" name="email_on_candidatenote_min_severity"  value="<?php echo $t_pref->email_on_candidatenote_min_severity ?>" />
		...
		<input type="hidden" name="email_candidatenote_limit" value="<?php echo $t_pref->email_candidatenote_limit ?>" />
<?php } ?>
<tr class="row-2">
	<td class="category">
