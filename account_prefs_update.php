...
# along with COSMOS.  If not, see <http://www.gnu.org/licenses/>.
	...
	$t_prefs->email_on_candidatenote	= gpc_get_bool( 'email_on_candidatenote' );
	...
	$t_prefs->email_on_candidatenote_min_severity		= gpc_get_int( 'email_on_candidatenote_min_severity' );
	...
	$t_prefs->candidatenote_order = gpc_get_string( 'candidatenote_order' );
	$t_prefs->email_candidatenote_limit = gpc_get_int( 'email_candidatenote_limit' );
