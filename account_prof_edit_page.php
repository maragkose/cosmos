...
<tr class="row-1">
	...
	<td width="75%">
		<input type="text" name="platform" size="255" maxlength="255" value="<?php echo string_attribute( $v_platform ) ?>" />
	</td>
</tr>
<tr class="row-2">
	<td class="category">
	...
	<td>
		<input type="text" name="os" size="255" maxlength="255" value="<?php echo string_attribute( $v_os ) ?>" />
	</td>
</tr>
<tr class="row-1">
	<td class="category">
