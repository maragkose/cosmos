...
# along with COSMOS.  If not, see <http://www.gnu.org/licenses/>.
	...
	# --------------------------------------------------------
	# $Id: account_update.php,v 1.1.1.1 2009/01/08 07:30:19 chirag Exp $
	# --------------------------------------------------------
	...
	if($_REQUEST['account_update_token']<>""){
	$t_redirect = 'candidate_report_advanced_page.php';
	}else{
	...
	# @@@ Listing what fields were updated is not standard behaviour of COSMOS
