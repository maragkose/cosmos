...
# along with COSMOS.  If not, see <http://www.gnu.org/licenses/>.
	...
	if( config_get( 'allow_file_upload' ) == ON ) {
		...
		echo get_capability_row( lang_get( 'upload_issue_attachments' ), config_get( 'upload_candidate_file_threshold' ) );
		echo get_section_end();
	}
	...
	if( config_get( 'enable_sponsorship' ) == ON ) {
		...
		echo get_capability_row( lang_get( 'assign_sponsored_issue' ), config_get( 'assign_sponsored_candidates_threshold' ) );
		echo get_capability_row( lang_get( 'handle_sponsored_issue' ), config_get( 'handle_sponsored_candidates_threshold' ) );
		echo get_section_end();
	}
	...
	echo get_capability_row( lang_get( 'send_reminders' ), config_get( 'candidate_reminder_threshold' ) );
