...
<?php
	...
	class UpgradeSet {
		...
		function UpgradeSet( $p_name='COSMOS Upgrade', $p_filename='cosmos_upgrade' ) {
	...
	$upgrade_set->add_items_with_check( 'upgrades/0_14_inc.php', $t_candidate_file_table );
	$upgrade_set->add_items_with_check( 'upgrades/0_15_inc.php', $t_candidate_history_table );
	$upgrade_set->add_items_with_check( 'upgrades/0_16_inc.php', $t_candidate_monitor_table );
