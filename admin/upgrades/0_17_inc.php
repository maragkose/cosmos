...
<?php
	...
	function upgrade_0_17_jf_2() {
		global $t_candidate_history_table;

		if ( !db_field_exists( 'type', $t_candidate_history_table ) ) {
			$query = "ALTER TABLE $t_candidate_history_table ADD type INT(2) NOT NULL";
	...
	$upgrades[] = new FunctionUpgrade(
		'0.17-jf-3',
		'Auto-assigning of candidates for a default user per category',
		'upgrade_0_17_jf_3' );
	...
	function upgrade_0_17_jf_6() {
		...
		if ( !db_field_exists( 'id', $t_candidate_relationship_table ) ) {
			$query = "ALTER TABLE $t_candidate_relationship_table ADD id INT(7) UNSIGNED ZEROFILL NOT
	...
	$upgrades[] = new SQLUpgrade(
		...
		"CREATE TABLE IF NOT EXISTS $t_custom_field_string_table (
		  ...
		  candidate_id int(7) NOT NULL,
		  value varchar(255) NOT NULL default '',
		  PRIMARY KEY (field_id,candidate_id))" );
	...
	$upgrades[] = new SQLUpgrade(
		'0.17-jf-8',
		'Drop votes column of mantis_candidate_table',
		"ALTER TABLE $t_candidate_table DROP COLUMN votes" );
	...
	$upgrades[] = new SQLUpgrade(
		'0.17-jf-12',
		'Add primary key on mantis_candidate_monitor_table',
		"ALTER IGNORE TABLE $t_candidate_monitor_table ADD PRIMARY KEY (user_id,candidate_id)" );

	$upgrades[] = new SQLUpgrade(
		'0.17-jf-13',
		'Remove zerofill on mantis_candidate_file_table.id',
		"ALTER TABLE $t_candidate_file_table
			MODIFY id int(7) unsigned NOT NULL auto_increment" );

	$upgrades[] = new SQLUpgrade(
		'0.17-jf-14',
		'Remove zerofill on mantis_candidate_file_table.candidate_id',
		"ALTER TABLE $t_candidate_file_table
			MODIFY candidate_id int(7) unsigned NOT NULL" );

	$upgrades[] = new SQLUpgrade(
		'0.17-jf-15',
		'Remove zerofill on mantis_candidate_history_table.user_id',
		"ALTER TABLE $t_candidate_history_table
			MODIFY user_id int(7) unsigned NOT NULL" );

	$upgrades[] = new SQLUpgrade(
		'0.17-jf-16',
		'Remove zerofill on mantis_candidate_history_table.candidate_id',
		"ALTER TABLE $t_candidate_history_table
			MODIFY candidate_id int(7) unsigned NOT NULL" );

	$upgrades[] = new SQLUpgrade(
		'0.17-jf-17',
		'Remove zerofill on mantis_candidate_monitor_table.user_id',
		"ALTER TABLE $t_candidate_monitor_table
			MODIFY user_id int(7) unsigned NOT NULL" );

	$upgrades[] = new SQLUpgrade(
		'0.17-jf-18',
		'Remove zerofill on mantis_candidate_relationship_table.id',
		"ALTER TABLE $t_candidate_relationship_table
			MODIFY id int(7) unsigned NOT NULL auto_increment" );

	$upgrades[] = new SQLUpgrade(
		'0.17-jf-19',
		'Remove zerofill on mantis_candidate_relationship_table.source_candidate_id',
		"ALTER TABLE $t_candidate_relationship_table
			MODIFY source_candidate_id int(7) unsigned NOT NULL default 0" );

	$upgrades[] = new SQLUpgrade(
		'0.17-jf-20',
		'Remove zerofill on mantis_candidate_relationship_table.destination_candidate_id',
		"ALTER TABLE $t_candidate_relationship_table
			MODIFY destination_candidate_id int(7) unsigned NOT NULL default 0" );

	$upgrades[] = new SQLUpgrade(
		'0.17-jf-21',
		'Remove zerofill on mantis_candidate_table.id',
		"ALTER TABLE $t_candidate_table
			MODIFY id int(7) unsigned NOT NULL auto_increment" );

	$upgrades[] = new SQLUpgrade(
		'0.17-jf-22',
		'Remove zerofill on mantis_candidate_table.project_id',
		"ALTER TABLE $t_candidate_table
			MODIFY project_id int(7) unsigned NOT NULL" );

	$upgrades[] = new SQLUpgrade(
		'0.17-jf-23',
		'Remove zerofill on mantis_candidate_table.reporter_id',
		"ALTER TABLE $t_candidate_table
			MODIFY reporter_id int(7) unsigned NOT NULL default 0" );

	$upgrades[] = new SQLUpgrade(
		'0.17-jf-24',
		'Remove zerofill on mantis_candidate_table.handler_id',
		"ALTER TABLE $t_candidate_table
			MODIFY handler_id int(7) unsigned NOT NULL default 0" );

	$upgrades[] = new SQLUpgrade(
		'0.17-jf-25',
		'Remove zerofill on mantis_candidate_table.duplicate_id',
		"ALTER TABLE $t_candidate_table
			MODIFY duplicate_id int(7) unsigned NOT NULL default 0" );

	$upgrades[] = new SQLUpgrade(
		'0.17-jf-26',
		'Remove zerofill on mantis_candidate_table.candidate_text_id',
		"ALTER TABLE $t_candidate_table
			MODIFY candidate_text_id int(7) unsigned NOT NULL" );

	$upgrades[] = new SQLUpgrade(
		'0.17-jf-27',
		'Remove zerofill on mantis_candidate_table.profile_id',
		"ALTER TABLE $t_candidate_table
			MODIFY profile_id int(7) unsigned NOT NULL default 0" );

	$upgrades[] = new SQLUpgrade(
		'0.17-jf-28',
		'Remove zerofill on mantis_candidate_text_table.id',
		"ALTER TABLE $t_candidate_text_table
			MODIFY id int(7) unsigned NOT NULL auto_increment" );

	$upgrades[] = new SQLUpgrade(
		'0.17-jf-29',
		'Remove zerofill on mantis_candidatenote_table.id',
		"ALTER TABLE $t_candidatenote_table
			MODIFY id int(7) unsigned NOT NULL auto_increment" );

	$upgrades[] = new SQLUpgrade(
		'0.17-jf-30',
		'Remove zerofill on mantis_candidatenote_table.candidate_id',
		"ALTER TABLE $t_candidatenote_table
			MODIFY candidate_id int(7) unsigned NOT NULL" );

	$upgrades[] = new SQLUpgrade(
		'0.17-jf-31',
		'Remove zerofill on mantis_candidatenote_table.reporter_id',
		"ALTER TABLE $t_candidatenote_table
			MODIFY reporter_id int(7) unsigned NOT NULL" );

	$upgrades[] = new SQLUpgrade(
		'0.17-jf-32',
		'Remove zerofill on mantis_candidatenote_table.candidatenote_text_id',
		"ALTER TABLE $t_candidatenote_table
			MODIFY candidatenote_text_id int(7) unsigned NOT NULL" );

	$upgrades[] = new SQLUpgrade(
		'0.17-jf-33',
		'Remove zerofill on mantis_candidatenote_text_table.id',
		"ALTER TABLE $t_candidatenote_text_table
			MODIFY id int(7) unsigned NOT NULL auto_increment" );
	...
	$upgrades[] = new SQLUpgrade(
		'0.17-compat-1',
		'Set default for mantis_candidate_file_table.date_added (incorrect for 0.15 installs)',
		"ALTER TABLE $t_candidate_file_table
	...
	$upgrades[] = new SQLUpgrade(
		'0.17-compat-2',
		'Correct values for mantis_candidate_file_table.date_added (incorrect for 0.15 installs)',
		"UPDATE $t_candidate_file_table
	...
	$upgrades[] = new SQLUpgrade(
		'0.17-compat-5',
		'Set default for mantis_candidate_table.build (incorrect for 0.16 installs)',
		"ALTER TABLE $t_candidate_table
	...
	$upgrades[] = new SQLUpgrade(
		'0.17-compat-6',
		'Correct values for mantis_candidate_table.build (incorrect for 0.16 installs)',
		"UPDATE $t_candidate_table
		  SET build=''
		  WHERE build='0'" );
	...
	$upgrades[] = new SQLUpgrade(
		'0.17-compat-12',
		'Set default for mantis_candidate_table.date_submitted (incorrect for < 0.17 installs)',
		"ALTER TABLE $t_candidate_table
	...
	$upgrades[] = new SQLUpgrade(
		'0.17-compat-13',
		'Correct values for mantis_candidate_table.date_submitted (incorrect for < 0.17 installs)',
		"UPDATE $t_candidate_table
	...
	$upgrades[] = new SQLUpgrade(
		'0.17-compat-14',
		'Set default for mantis_candidatenote_table.date_submitted (incorrect for < 0.17 installs)',
		"ALTER TABLE $t_candidatenote_table
		  MODIFY date_submitted datetime
		  NOT NULL
		  DEFAULT '1970-01-01 00:00:01'" );
	...
	$upgrades[] = new SQLUpgrade(
		'0.17-compat-15',
		'Correct values for mantis_candidatenote_table.date_submitted (incorrect for < 0.17 installs)',
		"UPDATE $t_candidatenote_table
		  SET date_submitted='1970-01-01 00:00:01'
		  WHERE date_submitted='0000-00-00 00:00:00'" );
	...
	$upgrades[] = new FunctionUpgrade(
		'0.17-vb-19',
		'Add id field to candidate history table',
		'upgrade_0_17_vb_19' );

	function upgrade_0_17_vb_19() {
		global $t_candidate_history_table;

		if ( !db_field_exists( 'id', $t_candidate_history_table ) ) {
			$query = "ALTER TABLE $t_candidate_history_table ADD id INT(7) UNSIGNED NOT NULL AUTO_INCREMENT PRIMARY KEY FIRST";
