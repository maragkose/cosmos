...
<?php
	...
	$upgrades[] = new SQLUpgrade(
			'candidatenote-type',
			'Add note type column to candidatenote',
			"ALTER TABLE $t_candidatenote_table ADD note_type INT(7) default '0'" );

	$upgrades[] = new SQLUpgrade(
			'candidatenote-attr',
			'Add note_attr column to candidatenote',
			"ALTER TABLE $t_candidatenote_table ADD note_attr VARCHAR(250) default ''" );
	...
	$upgrades[] = new SQLUpgrade(
			'sticky-issues',
			'Add sticky column to candidate table',
			"ALTER TABLE $t_candidate_table ADD sticky TINYINT(1) default '0' NOT NULL" );
