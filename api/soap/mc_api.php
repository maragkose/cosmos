<?php
	...
	function mci_is_cosmos_offline() {
		$t_offline_file = dirname( dirname( __FILE__ ) ) . DIRECTORY_SEPARATOR . 'cosmos_offline.php';
	 ...
	 * This internal function fixes this candidate.
	 *
	 * @return Mantis URL terminated by a /.
	 */
	function mci_get_cosmos_path() {
