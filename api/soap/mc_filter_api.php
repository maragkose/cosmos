<?php
	...
	function mc_filter_get_issues( $p_username, $p_password, $p_project_id, $p_filter_id, $p_page_number, $p_per_page ) {
		...
		$t_result = array();
		$t_rows = filter_get_candidate_rows( $p_page_number, $p_per_page, $t_page_count, $t_candidate_count, $t_filter, $p_project_id );
		foreach( $t_rows as $t_issue_data ) {
			...
			$t_steps_to_reproduce = candidate_get_text_field( $t_id, 'steps_to_reproduce' );
			$t_issue['steps_to_reproduce'] = mci_null_if_empty( $t_steps_to_reproduce );

			$t_additional_information = candidate_get_text_field( $t_id, 'additional_information' );
