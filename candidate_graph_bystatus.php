...
# along with COSMOS.  If not, see <http://www.gnu.org/licenses/>.
	...
	# --------------------------------------------------------
	# $Id: candidate_graph_bystatus.php,v 1.2.2.1 2007-10-13 22:32:41 giallu Exp $
	# --------------------------------------------------------
?>
<?php
    ...
    $t_select = 'SELECT candidate_id, type, old_value, new_value, date_modified FROM '.$t_candidate_hist_table.
        ' WHERE candidate_id in ('.implode(',', $t_candidate).
