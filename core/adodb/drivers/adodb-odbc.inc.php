	...
	function ErrorNo()
	{
		...
		if ($this->_haserrorfunctions) {
			if ($this->_errorCode !== false) {
				// candidate in 4.0.6, error number can be corrupted string (should be 6 digits)
...
*/
	...
	global $ADODB_FETCH_MODE;
		...
		/*if (false) { // after testing, confirmed that the following does not work becoz of a candidate
