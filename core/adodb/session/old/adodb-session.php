...
-- \$_SESSION['AVAR']={$_SESSION['AVAR']}</p>";
 ...
 1. Create this table in your database (syntax might vary depending on your db):
  ...
  3. Recommended is PHP 4.1.0 or later. There are documented
	 session candidates in earlier versions of PHP.
...
GLOBAL 	$ADODB_SESSION_CONNECT, 
	...
	if ($ADODB_SESS_LIFE <= 1) {
	 // candidate in PHP 4.0.3 pl 1  -- how about other versions?
...
-- Session Replace: '.$ADODB_SESS_CONN->ErrorMsg().'</p>',false);
		...
		// candidate in access driver (could be odbc?) means that info is not commited
