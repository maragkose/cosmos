...
// Class cosmosLink
//
// 09-18-2004 Bastian Pfennigschmidt for COSMOS Bugtracker
class cosmosLink extends urlmatch
{
	function cosmosLink()
	{
		parent::urlmatch();
