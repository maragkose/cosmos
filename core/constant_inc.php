...
# along with COSMOS.  If not, see <http://www.gnu.org/licenses/>.
	...
	define( 'FEEDBACK',			20 ); # Under Assessment
	define( 'ACKNOWLEDGED',		        30 ); # Assessment Passed
	define( 'CONFIRMED',		        40 ); # 1st Interview Scheduled
	define( 'ASSIGNED',			50 ); # 1st Interview Completed 
	define( 'COMPLETED',			60 ); # 2nd Interview Scheduled 
	define( 'RESOLVED',			80 ); # 2nd Interview Completed 
	define( 'CLOSED',			90 ); # Case closed
	...
	# priority
	define( 'NONE',			10 ); # Less than one
	define( 'LOW',			20 ); # 1 to 2
	define( 'NORMAL',		30 ); # 3 to 5
	define( 'HIGH',			40 ); # 6 to 8
	define( 'URGENT',		50 ); # 9 to 10
	define( 'IMMEDIATE',	60 );         # more than 10
	...
	# candidate relationship constants
	...
	define ( 'FIRST_INTERVIEW_INVITE', 1);
	define ( 'SECOND_INTERVIEW_INVITE', 2);
	define ( 'GENERIC_INVITE', 3);
