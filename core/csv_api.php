...
# along with COSMOS.  If not, see <http://www.gnu.org/licenses/>.
	...
	# --------------------
	# format candidate id
	function csv_format_id( $p_candidate_id ) {
		return candidate_format_id( $p_candidate_id );
	}
	...
	# --------------------
	# return the category
	function csv_format_category_id( $p_category ) {
		return csv_escape_string( $p_category );
	}
	...
	# --------------------
	# return the duplicate candidate id
	function csv_format_duplicate_id( $p_duplicate_id ) {
		return candidate_format_id( $p_duplicate_id );
	}
