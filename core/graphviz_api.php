	...
	class Graph {
		...
		function output( $p_format = 'dot', $p_headers = false ) {
			...
			if ( 'WIN' == substr( PHP_OS, 0, 3 ) ) {
				...
				# Issue #4625: Work around WinGraphviz candidate that fails with
				...
				# @@@  Remove this whole block once COSMOS PHP requirements
				# @@@  becomes higher.
				...
				$t_filename = tempnam( $t_tmpdir, 'cosmos-dot-' );
