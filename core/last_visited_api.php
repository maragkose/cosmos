...
# along with COSMOS.  If not, see <http://www.gnu.org/licenses/>.
	...
	#---------------------------------
	# This method should be called from view, update, print pages for issues, cosmosconnect.
	...
	#---------------------------------
	# Get an array of the last visited candidate ids.  We intentionally don't check if the ids still exists to avoid performance
	# degradation.
