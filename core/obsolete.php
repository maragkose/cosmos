...
# along with COSMOS.  If not, see <http://www.gnu.org/licenses/>.
	...
	config_obsolete( 'view_candidate_inc', '' );
	...
	config_obsolete( 'allow_candidate_delete_access_level', 'delete_candidate_threshold' );
	config_obsolete( 'candidate_move_access_level', 'move_candidate_threshold' );

	config_obsolete( 'php', '' );
	config_obsolete( 'use_experimental_custom_fields', '' );
	config_obsolete( 'mail_send_crlf', '' );

	config_obsolete( 'candidatenote_include_file', '' );
	config_obsolete( 'candidatenote_view_include_file', '' );
	config_obsolete( 'candidatenote_add_include_file', '' );
	config_obsolete( 'history_include_file', '' );
	config_obsolete( 'print_candidatenote_include_file', '' );
	config_obsolete( 'view_all_include_file', '' );
	config_obsolete( 'candidate_view_inc', '' );
	config_obsolete( 'candidate_file_upload_inc', '' );
...
# removed in 0.19
	...
	config_obsolete( 'close_candidate_threshold', 'set_status_threshold' );
