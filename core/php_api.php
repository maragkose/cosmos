...
# along with COSMOS.  If not, see <http://www.gnu.org/licenses/>.
	...
	if ( !php_version_at_least( PHP_MIN_VERSION ) ) {
		@ob_end_clean();
		PRINT '<b>FATAL ERROR: Your version of PHP is too old.  COSMOS requires PHP version ' . PHP_MIN_VERSION . ' or newer</b><br />Your version of PHP is version ' . phpversion();
		die();
	}
