...
if (!defined('RELATIVE_PATH')) define('RELATIVE_PATH','graph/src/FPDF/');
if (!defined('FPDF_FONTPATH')) define('FPDF_FONTPATH','graph/src/FPDF/font/');
...
var $shownoimg; //! bool
//variable requierd for print opton
//Added by Chirag
var $javascript;
var $n_js;
...
/* $e == content */
  ...
  if ($this->usecss) $html = $this->ReadCSS($html);
	...
	$html=str_replace('<?','< ',$html); //Fix '<?XML' candidate from HTML code generated by MS Word
...
//! @desc Prepares buffered text to be printed with FlowingBlock()
    ...
    if ($this->cssbegin and ($this->divborder or $this->dash_on or $this->dotted_on or $this->divbgcolor))
    {
        ...
        {
           //Only border on last page is painted (known candidate)
           $x = $this->lMargin;
           $y = $this->tMargin;
           $old_height = $this->y - $y;
        }
...
//end of function added by chirag ahmeadbadi
/////////////////////////END OF TABLE CODE//////////////////////////////////
