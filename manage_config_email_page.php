 ...
 */
	...
	function get_section_begin_for_email( $p_section_name ) {
		...
		echo '<td class="form-title" style="text-align:center" rowspan="2">&nbsp;' . lang_get( 'users_monitoring_candidate' ) . '&nbsp;</td>';
		echo '<td class="form-title" style="text-align:center" rowspan="2">&nbsp;' . lang_get( 'users_added_candidatenote' ) . '&nbsp;</td>';
	...
	function get_capability_row_for_email( $p_caption, $p_message_type ) {
		...
		echo '<td class="center"' . colour_notify_flag( $p_message_type, 'candidatenotes' ) . '>' . show_notify_flag( $p_message_type, 'candidatenotes' ) . '</td>';
	...
	$t_actions = array( 'owner', 'reopened', 'deleted', 'candidatenote' );
...
#		get_capability_row_for_email( lang_get( 'email_on_new' ), 'new' );  # duplicate of status change to 'new'
		...
		get_capability_row_for_email( lang_get( 'email_on_candidatenote_added' ), 'candidatenote' );
		if( config_get( 'enable_sponsorship' ) == ON ) {
