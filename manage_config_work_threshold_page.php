...
# along with COSMOS.  If not, see <http://www.gnu.org/licenses/>.
	...
	get_capability_row( lang_get( 'report_issue' ), 'report_candidate_threshold' );
    get_capability_enum( lang_get( 'submit_status' ), 'candidate_submit_status', 'status' );
	get_capability_row( lang_get( 'update_issue' ), 'update_candidate_threshold' );
	...
	get_capability_row( lang_get( 'monitor_issue' ), 'monitor_candidate_threshold' );
	get_capability_row( lang_get( 'handle_issue' ), 'handle_candidate_threshold' );
 	get_capability_row( lang_get( 'assign_issue' ), 'update_candidate_assign_threshold' );
	get_capability_row( lang_get( 'move_issue' ), 'move_candidate_threshold', true );
	get_capability_row( lang_get( 'delete_issue' ), 'delete_candidate_threshold' );
	get_capability_row( lang_get( 'reopen_issue' ), 'reopen_candidate_threshold' );
    get_capability_boolean( lang_get( 'allow_reporter_reopen' ), 'allow_reporter_reopen' );
    get_capability_enum( lang_get( 'reopen_status' ), 'candidate_reopen_status', 'status' );
    get_capability_enum( lang_get( 'reopen_resolution' ), 'candidate_reopen_resolution', 'resolution' );
    get_capability_enum( lang_get( 'resolved_status' ), 'candidate_resolved_status_threshold', 'status' );
    get_capability_enum( lang_get( 'readonly_status' ), 'candidate_readonly_status_threshold', 'status' );
	get_capability_row( lang_get( 'update_readonly_issues' ), 'update_readonly_candidate_threshold' );
	get_capability_row( lang_get( 'update_issue_status' ), 'update_candidate_status_threshold' );
	get_capability_row( lang_get( 'view_private_issues' ), 'private_candidate_threshold' );
    ...
    get_capability_enum( lang_get( 'assigned_status' ), 'candidate_assigned_status', 'status' );
    get_capability_boolean( lang_get( 'limit_access' ), 'limit_reporters', true );
	get_section_end();

	# Notes
	get_section_begin( lang_get( 'notes' ) );
	get_capability_row( lang_get( 'add_notes' ), 'add_candidatenote_threshold' );
	get_capability_row( lang_get( 'update_notes' ), 'update_candidatenote_threshold' );
    get_capability_boolean( lang_get( 'allow_user_edit' ), 'candidatenote_allow_user_edit_delete' );
	get_capability_row( lang_get( 'delete_note' ), 'delete_candidatenote_threshold' );
	get_capability_row( lang_get( 'view_private_notes' ), 'private_candidatenote_threshold' );
	get_section_end();
	...
	get_capability_row( lang_get( 'view' ) . ' ' . lang_get( 'candidate_history' ), 'view_history_threshold' );
	get_capability_row( lang_get( 'send_reminders' ), 'candidate_reminder_threshold' );
	get_section_end();
