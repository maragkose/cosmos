...
# along with COSMOS.  If not, see <http://www.gnu.org/licenses/>.
	...
	# --------------------------------------------------------
	# $Id: manage_proj_edit_page.php,v 1.1.1.1 2009/01/08 07:30:19 chirag Exp $
	# --------------------------------------------------------
	...
	//Updated by A Chirag to me changes on TinyMCE
?>
<br />
...
<tr <?php echo helper_alternate_class() ?>>
	...
	<td>
		<textarea name="description" cols="80" rows="20"><?php echo string_textarea( $row['description'] ) ?></textarea>
	</td>
</tr>
...
<tr <?php echo helper_alternate_class() ?>>
	...
	<td valign="top">
		<?php echo $t_subproject['description'];?>
	</td>
