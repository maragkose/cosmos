...
# along with COSMOS.  If not, see <http://www.gnu.org/licenses/>.
	...
	# --------------------------------------------------------
	# $Id: print_all_candidate_options_inc.php,v 1.25.2.1 2007-10-13 22:34:11 giallu Exp $
	# --------------------------------------------------------
?>
<?php
...
function edit_printing_prefs( $p_user_id = null, $p_error_if_protected = true, $p_redirect_url = '' )
{
	...
	if ( is_blank( $p_redirect_url ) ) {
		$p_redirect_url = 'print_all_candidate_page.php';
	}
...
<br />
<div align="center">
<form method="post" action="print_all_candidate_options_update.php">
...
<div class="border-center">
	<form method="post" action="print_all_candidate_options_reset.php">
