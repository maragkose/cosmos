...
# along with COSMOS.  If not, see <http://www.gnu.org/licenses/>.
	...
	# --------------------------------------------------------
	# $Id: print_all_candidate_page_word.php,v 1.65.2.1 2007-10-13 22:34:17 giallu Exp $
	# --------------------------------------------------------
?>
<?php
	# Word 2000 export page
	# The candidates displayed in print_all_candidate_page.php are saved in a .doc file
...
<?php
	//$t_candidate_arr_sort[$row_count]=-1;
	...
	for( $j=0; $j < $row_count; $j++ ) {
		...
		# display the available and selected candidates
		if ( in_array( $v_id, $f_candidate_arr ) || ( $f_show_flag==0 ) ) {
            ...
            ### note that dates are converted to unix format in filter_get_candidate_rows
?>
<br />
...
<tr class="print">
	...
	<td class="print">
		<?php 
			if ( access_has_candidate_level( config_get( 'view_handler_threshold' ), $v_id ) ) {
