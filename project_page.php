...
# along with COSMOS.  If not, see <http://www.gnu.org/licenses/>.
	...
	$t_view_issues_url = "set_project.php?project_id=$f_project_id&ref=view_all_candidate_page.php";
	...
	# View Issues
	echo '<a href="', $t_view_issues_url, '">', lang_get( 'view_candidates_link' ), '</a>';
