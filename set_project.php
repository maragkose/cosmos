...
# along with COSMOS.  If not, see <http://www.gnu.org/licenses/>.
	...
	# --------------------------------------------------------
	# $Id: set_project.php,v 1.1.1.1 2009/01/08 07:30:19 chirag Exp $
	# --------------------------------------------------------
	...
	if ( !is_blank( $c_ref ) ) {
		...
		if ( strtolower( $t_path ) == strtolower( substr( $_SERVER['HTTP_REFERER'], 0, strlen( $t_path ) ) ) ) {
			...
			# if view_all_candidate_page, pass on filter	
			if ( eregi( 'view_all_candidate_page.php', $t_referrer_page ) ) {
				...
				switch ($t_path ) {
					case 'candidate_view_page.php':
					case 'candidate_view_advanced_page.php':
					case 'candidate_update_page.php':
					case 'candidate_update_advanced_page.php':
					case 'candidate_change_status_page.php':
						$t_path = $t_home_page;
						break;
					default:					
						$t_path = $t_referrer_page;
...
//Updated by Chirag Ahmedbadi
//Patch for Public page
if($_REQUEST['f_ref']=='=candidate_report_advanced_page.php'){
		$t_redirect_url="candidate_report_advanced_page.php";
