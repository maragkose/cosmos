...
<tr valign="top">
	<td width="50%">
		...
		<tr>
			<td class="document-form" colspan="5">
				<?php echo lang_get( 'time_stats' ) ?>
			</td>
		</tr>
		<tr class="row-1">
			<td width="50%">
				<?php echo lang_get( 'longest_open_candidate' ) ?>
			</td>
			<td width="50%">
				<?php
					if ($t_candidate_id>0) {
						print_candidate_link( $t_candidate_id );
					}
				?>
			</td>
		</tr>
	...
	<td width="50%">
		...
		<table class="width100" cellspacing="1">
		<tr>
			<td class="document-form"><?php echo lang_get( 'by_date' ); ?></td>
		...
		<table class="width100" cellspacing="1">
		<tr>
			<td class="document-form" width="86%"><?php echo lang_get( 'most_active' ); ?></td>
		...
		<table class="width100" cellspacing="1">
		<tr>
			<td class="document-form" width="86%"><?php echo lang_get( 'longest_open' ); ?></td>
