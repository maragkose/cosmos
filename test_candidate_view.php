...
<tr>
	...
	<td class="center"><span class="small">
		<?php
			...
			if( false !== $t_index ) {
				if( isset( $t_candidateslist[$t_index-1] ) ) print_bracket_link( 'candidate_view_advanced_page.php?candidate_id='.$t_candidateslist[$t_index-1], '&lt;&lt;' );
				if( isset( $t_candidateslist[$t_index+1] ) ) print_bracket_link( 'candidate_view_advanced_page.php?candidate_id='.$t_candidateslist[$t_index+1], '&gt;&gt;' );
			}
		?>
	</span></td>
	...
	<?php if ( $t_can_view_history ) { ?>
		<!-- History -->
		<span class="small"><?php print_bracket_link( 'candidate_view_advanced_page.php?candidate_id=' . $f_candidate_id . '&amp;history=1#history', lang_get( 'candidate_history' ) ) ?></span>
	<?php } ?>
...
<tr <?php echo helper_alternate_class() ?>>
	...
	<td>
		<?php echo $t_candidate->fixed_in_version ?>
	</td>
		<?php
			} else {
		?>
...
?>
	...
	<td>
		<?php echo $t_candidate->target_version ?>
	</td>
<?php
	} else {
?>
...
?>
	...
	<td colspan="1">
		<?php echo $t_candidate->steps_to_reproduce ?>
	</td>
</tr>
