...
define("RESULTS_DIR_PATH", "answers");
...
define("TEXT_RESULTS_EXTENSION", "ans");
...
define("CUESTIONARIO_GET_VAR", "test");

// Textos utilizados en los botones y mensajes de notificación del cuestionario
define("TXT_SEND_FORM","Submit");
define("TXT_START_FORM","Start the test");
